...
options.acc_threshold = 0.05*G;   %choose a value
options.ssd_threshold = 0.1*G;   %choose a value;
options.time_threshold = 0.1;  %choose a value %[s]
...
%-------------------------------------------------------------------------%
options.MinPeakDistance = 0.3; %choose a value
options.MinPeakHeight = 0.1;   %choose a value
